...
class ChatBot {
    constructor() {
        ...
        // ****************************************************************
        this.webhookUrl = 'https://annie9121.app.n8n.cloud/webhook/chatb';
        // ****************************************************************        
    ...
    loadChatHistory() {
        ...
        if (recentHistory.length === 0) {
            ...
            setTimeout(() => {
                this.addMessage('Hello! I\'m 陳依\'s AI Assistant. Do you have any questions?', 'ai');
            }, 1000);
        }
    }
